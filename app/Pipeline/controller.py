...
# Once classes done for all above,
# will be able to just import one class per file
import requests
import time
import json
import re
...
# Controller will contain summation functions to get
# new data from API's validate, and put into DB & S3 bucket
...
class Controller(object):
    ...
    def get_two_hundred_years_tides(self):
        """
        runs get_historical_tide() from buoy_tide_weather.py
        passes to insert_tide() from db.py
        """
